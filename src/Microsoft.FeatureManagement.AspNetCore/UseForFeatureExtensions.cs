...
namespace Microsoft.FeatureManagement.AspNetCore
{
    ...
    public static class UseForFeatureExtensions
    {
        ...
        /// <returns></returns>
        public static IApplicationBuilder UseForFeature(this IApplicationBuilder app, string featureName,
        ...
        public static IApplicationBuilder UseMiddlewareForFeature<T>(this IApplicationBuilder app, string featureName)
        {
            ...
            return app.UseForFeature(featureName, builder => { builder.UseMiddleware<T>(); });
        }
    }
}