...
namespace Microsoft.FeatureManagement
{
    ...
    internal class ContextualFeatureFilterEvaluator : IContextualFeatureFilter<object>
    {
        ...
        {
            return _evaluateFunc == null ? Task.FromResult(false) : _evaluateFunc(_filter, evaluationContext, context);
        }
        ...
        private static Func<object, FeatureFilterEvaluationContext, object, Task<bool>> GenericTypeAgnosticEvaluate<TTarget, TParam1, TParam2, TReturn>(MethodInfo method)
        {
            ...
            Func<object, FeatureFilterEvaluationContext, object, Task<bool>> genericDelegate = (target, param1, param2) => func((TTarget)target, param1, (TParam2)param2);
