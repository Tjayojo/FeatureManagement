...
namespace Microsoft.FeatureManagement.FeatureFilters
{
    ...
    {
        private const string Alias = "Percentage";
        ...
        {
            var settings = (PercentageFilterSettings) context.Parameters;
            ...
            {
                _logger.LogWarning(
                    $"The '{Alias}' feature filter does not have a valid '{nameof(settings.Value)}' value for feature '{context.FeatureName}'");
