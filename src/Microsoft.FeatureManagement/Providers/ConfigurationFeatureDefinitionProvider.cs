...
namespace Microsoft.FeatureManagement.Providers
{
    ...
    /// </summary>
    internal sealed class ConfigurationFeatureDefinitionProvider : IFeatureDefinitionProvider, IDisposable
    {
...
#pragma warning restore CS1998
        ...
        private FeatureDefinition ReadFeatureDefinition(string featureName)
        {
            ...
            return configuration == null ? null : ReadFeatureDefinition(configuration);
        }
